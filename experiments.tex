...
for picking up the frying pan. The green points refer to where the gripper will be placed. Our system learned to prefer picking up the pan at its handle to fit it into the
...
it by chance picked grasp poses along the handle. \figref{fig:frying} compares the hand-coded
