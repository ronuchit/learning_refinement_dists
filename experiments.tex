...
For training graph search, we use the following feature vector $f(n)$ associated with a high-level plan. Because the plan is composed
...
we found that performance plateaued. We use $C = 10^{9}$ in solving the max-margin optimization problem.
