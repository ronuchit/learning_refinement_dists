...
For the dinner domain, we report results only for the first 2 systems, because objects
...
the robot is approaching. For putdown locations, the range is defined by the table.
