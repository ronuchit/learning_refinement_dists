...
\begin{figure}[t]
  \centering
    \noindent
    \includegraphics[scale=0.2]{images/move_grasp.png}\hspace{5 mm}
    \includegraphics[scale=0.2]{images/move_putdown.png}
  \caption{Screenshots showing distributions learned by our system in a simulated pick-and-place
