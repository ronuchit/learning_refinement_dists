...
\item $\T$ is a set of object \emph{types}, such as movable objects, trajectories, poses, and locations.
...
must acquire skills from observing a demonstrator. Standard techniques include
