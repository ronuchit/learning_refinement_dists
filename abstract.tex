...
through a \emph{plan refinement graph}, a data structure whose nodes store candidate symbolic
plans for reaching the goal state and their current refinements. This allows our system
