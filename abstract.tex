...
to plan for such goals by combining task and motion planning. These systems
attempt to refine symbolic plans using an interface layer,
which searches for a feasible assignment of continuous pose values to the plan's symbolic parameters. A core limitation
...
distributions for sampling pose values. Our contributions are: 1) a machine learning
